...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["X", "[CLS]", "[SEP]", '', 'B-ABBREVIATION', 'B-CLASS', 'I-CLASS', 'B-MULTIPLE', 'B-IDENTIFIER', 'I-MULTIPLE', 'I-TRIVIAL', 'B-TRIVIAL', 'I-SYSTEMATIC', 'I-IDENTIFIER', 'B-SYSTEMATIC', 'I-FAMILY', 'B-FORMULA', 'I-ABBREVIATION', 'I-FORMULA', 'O', 'B-FAMILY']
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        with open(os.path.join(FLAGS.output_dir, 'label2id.pkl'),'rb') as rf:
            ...
            id2label = {value:key for key,value in list(label2id.items())}
